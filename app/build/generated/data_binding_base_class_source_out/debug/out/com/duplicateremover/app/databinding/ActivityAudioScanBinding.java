...
public final class ActivityAudioScanBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityAudioScanBinding(@NonNull CoordinatorLayout rootView, @NonNull CardView bottomBar,
  ...
  @NonNull
  public static ActivityAudioScanBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAudioScanBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_audio_scan, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAudioScanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAudioScanBinding((CoordinatorLayout) rootView, bottomBar, deleteButton,
