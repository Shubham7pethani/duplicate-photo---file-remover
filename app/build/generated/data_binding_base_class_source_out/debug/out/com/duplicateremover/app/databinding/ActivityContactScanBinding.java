...
public final class ActivityContactScanBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityContactScanBinding(@NonNull CoordinatorLayout rootView,
  ...
  @NonNull
  public static ActivityContactScanBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityContactScanBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_contact_scan, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityContactScanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityContactScanBinding((CoordinatorLayout) rootView, bottomBar, deleteButton,
