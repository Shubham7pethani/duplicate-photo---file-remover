...
public final class ActivityDocScanBinding implements ViewBinding {
  ...
  private ActivityDocScanBinding(@NonNull CoordinatorLayout rootView, @NonNull CardView bottomBar,
  ...
  public static ActivityDocScanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDocScanBinding((CoordinatorLayout) rootView, bottomBar, deleteButton,
