...
public final class ActivityDocScanBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityDocScanBinding(@NonNull CoordinatorLayout rootView, @NonNull ImageView backButton,
  ...
  @NonNull
  public static ActivityDocScanBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityDocScanBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_doc_scan, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityDocScanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDocScanBinding((CoordinatorLayout) rootView, backButton, bottomBar,
