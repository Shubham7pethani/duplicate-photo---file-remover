...
public final class ActivityVideoScanBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityVideoScanBinding(@NonNull CoordinatorLayout rootView, @NonNull CardView bottomBar,
  ...
  @NonNull
  public static ActivityVideoScanBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityVideoScanBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_video_scan, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityVideoScanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityVideoScanBinding((CoordinatorLayout) rootView, bottomBar, deleteButton,
