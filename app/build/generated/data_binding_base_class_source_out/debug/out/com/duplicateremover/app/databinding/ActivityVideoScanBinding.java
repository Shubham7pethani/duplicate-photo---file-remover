...
public final class ActivityVideoScanBinding implements ViewBinding {
  ...
  private ActivityVideoScanBinding(@NonNull CoordinatorLayout rootView,
  ...
  public static ActivityVideoScanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityVideoScanBinding((CoordinatorLayout) rootView, backButton, bottomBar,
