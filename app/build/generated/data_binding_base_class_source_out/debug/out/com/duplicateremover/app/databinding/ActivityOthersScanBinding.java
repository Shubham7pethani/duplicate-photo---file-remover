...
public final class ActivityOthersScanBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityOthersScanBinding(@NonNull CoordinatorLayout rootView,
  ...
  @NonNull
  public static ActivityOthersScanBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityOthersScanBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_others_scan, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityOthersScanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOthersScanBinding((CoordinatorLayout) rootView, backButton, bottomBar,
