...
public final class ActivityPhotoScanBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityPhotoScanBinding(@NonNull CoordinatorLayout rootView, @NonNull CardView bottomBar,
  ...
  @NonNull
  public static ActivityPhotoScanBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityPhotoScanBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_photo_scan, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityPhotoScanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPhotoScanBinding((CoordinatorLayout) rootView, bottomBar, deleteButton,
