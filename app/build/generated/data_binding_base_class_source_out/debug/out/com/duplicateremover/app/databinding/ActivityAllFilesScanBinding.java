...
public final class ActivityAllFilesScanBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityAllFilesScanBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAllFilesScanBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_all_files_scan, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAllFilesScanBinding bind(@NonNull View rootView) {
