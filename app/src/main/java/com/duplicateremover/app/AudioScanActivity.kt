...
import com.duplicateremover.app.databinding.ActivityAudioScanBinding
...
class AudioScanActivity : AppCompatActivity() {
    ...
    private fun startScanning() {
        ...
        binding.fileCountText.text = "0 Audios Scanned"
        ...
        contentResolver.query(
            ...
            while (cursor.moveToNext()) {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    binding.fileCountText.text = "$current Audios Scanned"
                }
    ...
    private suspend fun findDuplicates() {
        withContext(Dispatchers.Main) {
            binding.statusText.text = "Comparing audios..."
        }
    ...
    private fun updateBottomBarStats() {
        ...
        binding.selectedStatsText.text = "${selectedFiles.size} audios selected"
    ...
    private fun showDeleteConfirmation(files: List<MediaFile>) {
        ...
        dialogView.findViewById<android.widget.TextView>(R.id.dialogMessage).text = 
            "Delete ${files.size} duplicate audios (${formatSize(totalSize)})"
        dialogView.findViewById<android.widget.TextView>(R.id.dialogSubMessage).text = 
            "Original audios will be kept safe."
