...
import com.duplicateremover07.app.databinding.ActivityPhotoScanBinding
...
class PhotoScanActivity : BaseActivity() {
    ...
    private fun startScanning() {
        ...
        binding.fileCountText.text = getString(R.string.photos_scanned, 0)
    ...
    private suspend fun scanPhotos() {
        ...
        contentResolver.query(
            ...
            while (cursor.moveToNext()) {
                ...
                if (size > 0 && path != null && File(path).exists()) {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    binding.fileCountText.text = getString(R.string.photos_scanned, current)
                }
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                    ...
                    for ((index, file) in files.withIndex()) {
                        try {
                            val itemUri = ContentUris.withAppendedId(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, file.id)
                ...
                withContext(Dispatchers.Main) {
                    ...
                    binding.bottomBar.visibility = View.VISIBLE
                    pendingFilesToDelete = null
                    Toast.makeText(this@PhotoScanActivity, "Delete failed: ${e.message}", Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
    ...
    private fun showDeleteProgress() {
        ...
        binding.scanTitleText.text = "Deleting Photos"
        binding.scanProgressCircle.setProgress(0)
    ...
    private fun finalizeDeletion(deletedFiles: List<MediaFile>) {
        ...
        Toast.makeText(this, "Deleted ${deletedFiles.size} photos", Toast.LENGTH_SHORT).show()
    }
}
