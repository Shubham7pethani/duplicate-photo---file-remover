...
import com.duplicateremover07.app.databinding.ActivityAllFilesScanBinding
...
class AllFilesScanActivity : BaseActivity() {
    ...
    private suspend fun scanAllFiles() {
        ...
        contentResolver.query(
            ...
            while (cursor.moveToNext()) {
                ...
                if (size > 0 && path.isNotEmpty() && File(path).exists() && 
