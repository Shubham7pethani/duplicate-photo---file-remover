...
import com.duplicateremover07.app.databinding.ActivityApkScanBinding
...
class ApkScanActivity : BaseActivity() {
    ...
    private fun startScanning() {
        ...
        binding.fileCountText.text = getString(R.string.apks_scanned, 0)
            ...
            files?.forEach { file ->
                ...
                if (expectedTotal > 0) {
                    ...
                    withContext(Dispatchers.Main) {
                        ...
                        binding.fileCountText.text = getString(R.string.apks_scanned, scanned)
                    }
                }
            }
        }
    ...
    private suspend fun readApkCursorIntoList(
        ...
        while (cursor.moveToNext()) {
            ...
            withContext(Dispatchers.Main) {
                binding.scanProgressCircle.setProgress(progress)
                binding.fileCountText.text = getString(R.string.apks_scanned, current)
            }
