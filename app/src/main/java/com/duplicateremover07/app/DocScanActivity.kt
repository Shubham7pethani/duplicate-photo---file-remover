...
import com.duplicateremover07.app.databinding.ActivityDocScanBinding
...
class DocScanActivity : BaseActivity() {
    ...
    private fun startScanning() {
        ...
        binding.fileCountText.text = getString(R.string.docs_scanned, 0)
        ...
        contentResolver.query(
            ...
            while (cursor.moveToNext()) {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    binding.fileCountText.text = getString(R.string.docs_scanned, current)
                }
