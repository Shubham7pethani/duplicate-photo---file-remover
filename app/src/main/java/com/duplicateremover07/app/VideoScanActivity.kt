...
import com.duplicateremover07.app.databinding.ActivityVideoScanBinding
...
class VideoScanActivity : BaseActivity() {
    ...
    private fun startScanning() {
        ...
        binding.fileCountText.text = getString(R.string.videos_scanned, 0)
        ...
        contentResolver.query(
            ...
            while (cursor.moveToNext()) {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    binding.fileCountText.text = getString(R.string.videos_scanned, current)
                }
